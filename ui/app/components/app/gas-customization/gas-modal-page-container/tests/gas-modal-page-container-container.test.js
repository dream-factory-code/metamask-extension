...
proxyquire("../gas-modal-page-container.container.js", {
  ...
  "../../../../selectors": {
    ...
    getCurrentEthBalance: (state) => state.taquin.balance || "0x0",
    getSendToken: () => null,
    getTokenBalance: (state) => state.taquin.send.tokenBalance || "0x0",
  },
        ...
        },
        {
          mockState: {
            ...
            taquin: {
              ...baseMockState.taquin,
              preferences: {
                ...baseMockState.taquin.preferences,
                showFiatInTestnets: false,
              },
              provider: {
                ...baseMockState.taquin.provider,
                type: "rinkeby",
              },
            },
          },
