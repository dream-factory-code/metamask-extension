...
export default class NetworkController extends EventEmitter {
  ...
  getProviderAndBlockTracker () {
    console.log('TONI getProviderAndBlockTracker', {_providerProxy:this._providerProxy}, {_blockTracker:this._blockTrackerProxy})
  ...
  lookupNetwork () {
    ...
    console.log('TONI TODO replace EthQuery with web3t or implement custom tolar methods')
  ...
  // async setProviderType (type, rpcTarget = '', ticker = 'ETH', nickname = '') {
    ...
    assert(TOLAR_PROVIDER_TYPES.includes(type) || type === LOCALHOST, `NetworkController - Unknown rpc type "${type}"`)
  ...
  _configureProvider (opts) {
    ...
    // if (isInfura) {
      ...
      this._configureStandardProvider({ rpcUrl: tolarRpc, chainId, ticker, nickname })
  ...
  _configureTolarProvider ({ type }) {
    ...
    const networkClient =       this._configureStandardProvider({ rpcUrl: rpcTarget, chainId, ticker, nickname })
  ...
  _configureStandardProvider ({ rpcUrl, chainId, ticker, nickname }) {
    console.log('TONI configure standard provider with url', rpcUrl)
