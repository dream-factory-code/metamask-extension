...
- Load older version of Taquin and attempt to simulate updating the extension.
...
- Token Management
  ...
  - Send that token to another taquin address.
...
- Ganache set blocktime to simulate retryTx in Taquin
