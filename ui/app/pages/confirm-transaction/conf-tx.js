...
function mapStateToProps(state) {
  ...
  return {
    identities: state.taquin.identities,
    mostRecentOverviewPage: getMostRecentOverviewPage(state),
    unapprovedTxs: state.taquin.unapprovedTxs,
    unapprovedMsgs: state.taquin.unapprovedMsgs,
    unapprovedPersonalMsgs: state.taquin.unapprovedPersonalMsgs,
    unapprovedTypedMessages: state.taquin.unapprovedTypedMessages,
    index: txId,
    warning: state.appState.warning,
    network: state.taquin.network,
    provider: state.taquin.provider,
    currentCurrency: state.taquin.currentCurrency,
    blockGasLimit: state.taquin.currentBlockGasLimit,
    unapprovedMsgCount,
    unapprovedPersonalMsgCount,
    unapprovedTypedMessagesCount,
    send: state.taquin.send,
    currentNetworkTxList: state.taquin.currentNetworkTxList,
  };
}
