...
const UPDATE_TX_DATA = "taquin/confirm-transaction/UPDATE_TX_DATA";
const CLEAR_TX_DATA = "taquin/confirm-transaction/CLEAR_TX_DATA";
const UPDATE_TOKEN_DATA = "taquin/confirm-transaction/UPDATE_TOKEN_DATA";
const CLEAR_TOKEN_DATA = "taquin/confirm-transaction/CLEAR_TOKEN_DATA";
const UPDATE_METHOD_DATA = "taquin/confirm-transaction/UPDATE_METHOD_DATA";
const CLEAR_METHOD_DATA = "taquin/confirm-transaction/CLEAR_METHOD_DATA";
const UPDATE_TRANSACTION_AMOUNTS =
  "taquin/confirm-transaction/UPDATE_TRANSACTION_AMOUNTS";
const UPDATE_TRANSACTION_FEES =
  "taquin/confirm-transaction/UPDATE_TRANSACTION_FEES";
const UPDATE_TRANSACTION_TOTALS =
  "taquin/confirm-transaction/UPDATE_TRANSACTION_TOTALS";
const UPDATE_TOKEN_PROPS = "taquin/confirm-transaction/UPDATE_TOKEN_PROPS";
const UPDATE_NONCE = "taquin/confirm-transaction/UPDATE_NONCE";
const UPDATE_TO_SMART_CONTRACT =
  "taquin/confirm-transaction/UPDATE_TO_SMART_CONTRACT";
const FETCH_DATA_START = "taquin/confirm-transaction/FETCH_DATA_START";
const FETCH_DATA_END = "taquin/confirm-transaction/FETCH_DATA_END";
const CLEAR_CONFIRM_TRANSACTION =
  "taquin/confirm-transaction/CLEAR_CONFIRM_TRANSACTION";
  ...
  describe("Thunk actions", function () {
    ...
    it("updates txData and gas on an existing transaction in confirmTransaction", function () {
      ...
      const expectedActions = [
        "taquin/confirm-transaction/UPDATE_TX_DATA",
        "taquin/confirm-transaction/UPDATE_TRANSACTION_AMOUNTS",
        "taquin/confirm-transaction/UPDATE_TRANSACTION_FEES",
        "taquin/confirm-transaction/UPDATE_TRANSACTION_TOTALS",
      ];
