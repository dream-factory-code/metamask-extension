...
// remote state
export const UPDATE_TAQUIN_STATE = "UPDATE_TAQUIN_STATE";
...
export const LOCK_TAQUIN = "LOCK_TAQUIN";
// error handling
...
export const SET_OPEN_TAQUIN_TAB_IDS = "SET_OPEN_TAQUIN_TAB_IDS";

export const TX_PAGE_CHANGE = "TX_PAGE_CHANGE";
