...
export default class Routes extends Component {
  ...
  getConnectingLabel(loadingMessage) {
    ...
    switch (provider.type) {
      case "mainnet":
        return "Connecting To MainNet" || this.context.t("connectingToMainnet");
      case "stagingnet":
        return (
          "Connecting To StagingNet" || this.context.t("connectingToStagingnet")
        );
      case "testnet":
        return "Connecting To TestNet" || this.context.t("connectingToTestnet");
      // case 'rinkeby':
  ...
  getNetworkName() {
    switch (this.props.provider.type) {
      ...
      case "stagingnet":
        return this.context.t("stagingnet") || "Staging Net";
      case "testnet":
        return this.context.t("testnet") || "Test Net";
      // case "rinkeby":
