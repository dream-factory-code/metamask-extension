...
export default class MetamaskController extends EventEmitter {
  ...
  constructor(opts) {
    ...
    console.log(`initialized provider and set to: \n `, this.provider);
    console.log(`set block tracker: \n`, this.blockTracker);
    ...
    // })
    console.log("TONI should construct keyring controller");
    ...
    console.log("TONI keyring controller", this.keyringController);
  ...
  async createNewVaultAndKeychain(password) {
    console.log("TONI mm-ctrl createNewVaultAndKeychain ");

    const releaseLock = await this.createVaultMutex.acquire();
    console.log("TONI mm-ctrl releaseLock ", releaseLock);
    try {
      let vault;
  ...
  async verifySeedPhrase() {
    console.log("TONI mm-ctrl verify seed phrase");
    //const primaryKeyring = this.keyringController.getKeyringsByType('HD Key Tree')[0]
    const primaryKeyring = this.keyringController.getKeyringsByType(
      "Tolar Keyring"
    )[0];
